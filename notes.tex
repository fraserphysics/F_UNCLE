...
\emph{true} EOS differ from the nominal EOS and the by a sum of
Gaussian bumps characterized by a center volume $v_k$, a width $w_k$
and a scale $s_k$, with
\begin{equation*}
...
\begin{figure}
  \centering
    ...
    \caption{Fisher Information of the Gun Experiment.  The sequence
      ...
      eigenfunctions corresponding to the largest four eigenvalue
      appears in the lower left.}
  \label{fig:info_gun}
\end{figure}
