...
\begin{abstract}
  ...
  like\_eos/notes.tex\footnote{Run \emph{git clone git clone
      ssh://lanl.fraserphysics.com:/home/git/like\_eos} to obtain the
    source.}.  I use the same ideas for work on the 9501 model on
  moonlight.
\end{abstract}
...
rank of $\Fisher(\hat c)$ to within machine
precision.\marginpar{explain constraint}.
...
\begin{figure}
  \centering
    ...
    \caption{Fisher Information of the Rate Stick Experiment.  The
      ...
      eigenvalues of$\Fisher(\hat c)$ appear in the lower left and the
      eigenfunction corresponding to the largest eigenvalue appears in
      the lower left.}
...
Source file: ssh://lanl.fraserphysics.com:/home/git/like\_eos/notes.tex
