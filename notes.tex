...
\begin{abstract}
  ...
  like\_eos/notes.tex\footnote{Run \emph{git clone
      https://github.com/fraserphysics/like\_eos} to obtain the source.}.
...
Source file: https://github.com/fraserphysics/like\_eos/notes.tex
