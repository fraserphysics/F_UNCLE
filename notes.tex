...
\begin{abstract}
  ...
  https://github.com/fraserphysics/F\_UNCLE\footnote{To
...
\item[fit\_t2v] Run a simulation to build a spline for mapping times
  ...
  \begin{figure}
    ...
    \caption{Velocities as functions of time.  Traces for the
      ...
      $\mu_\eos$, and the error, $\epsilon$ appear in the upper
      plot.  The corresponding EOSs appear in the lower plot.}
    \label{fig:vt_gun}
  \end{figure}
...
\begin{figure}
  \centering
    ...
    \caption{Fisher Information of the Gun Experiment.  The sequence
      ...
      the upper right.  The largest nine eigenvalues of
      $\Fisher(\hat c)$ appear in the lower left and the
      eigenfunctions corresponding to the largest four eigenvalues
...
\ref{fig:info_gun} and \ref{fig:fve_gun}.  Three iterations of the
...
\begin{figure}
  \centering
    ...
    \caption{Sequential estimation of the maximum a posteriori
      ...
      \emph{experimental} in the upper plot, and the optimization
      starts with the \emph{nominal} and ends with \emph{fit}.  The
      corresponding velocity for the gun as a function of position
      appears in the middle plot, and the sequence of errors in the
      forecast velocity time series after each step in the
      optimization appears in the lower plot. The estimation also used
      experimental data from the rate stick.}
  \label{fig:fve_gun}
\end{figure}
...
Source file: https://github.com/fraserphysics/F\_UNCLE/notes.tex
