...
if __name__ == '__main__':
    ...
    # f1ax1.plot(None,None,'-k', label = "Fit EOS")
    # f1ax1.plot(None,None,'-r', label = "Rayleigh line")
    # f1ax1.plot(None,None,'--k', label = "Prior EOS")
    # f1ax1.plot(None,None,'-.k', label = "True EOS")
    ...
    fig1.tight_layout()
    fig1.savefig('scipy2016_figure1'+figtype)

    # Figure 2

    fisher = analysis.get_fisher_matrix(simid = 1, sens_calc = False)
    spec_data = analysis.fisher_decomposition(fisher)

    fig2 = analysis.plot_fisher_data(spec_data)
    fig2.set_size_inches(tall)
    fig2.savefig('scipy2016_figure2'+figtype)
    ...
    fig3.savefig('scipy2016_figure3'+figtype)
    ...
    gun_simulation.plot(axis = f4ax2, style = '--k' ,
                        data = [gun_prior_sim])
    fig4.tight_layout()
    fig4.savefig('scipy2016_figure4'+figtype)

    # Figure 5

    fisher = analysis.get_fisher_matrix(simid = 0, sens_calc = False)
    spec_data = analysis.fisher_decomposition(fisher)

    fig5 = analysis.plot_fisher_data(spec_data)
    fig5.set_size_inches(tall)
    fig5.tight_layout()
    fig5.savefig('scipy2016_figure5'+figtype)
    ...
    fig6.tight_layout()
    fig6.savefig('scipy2016_figure6'+figtype)
