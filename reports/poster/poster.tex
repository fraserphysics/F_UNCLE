...
\begin{textblock}{4}(\colE,\EOSY)
  \vspace{2cm}
  \begin{center}
  \resizebox{0.9\textwidth}{!}{\includegraphics{static_figs/real.pdf}}\\
...
\begin{textblock}{4}(\colB,\StickY)
  ...
  \resizebox{0.9\textwidth}{!}{\includegraphics{static_figs/stick_poster.pdf}}\\
\end{textblock}
...
\begin{textblock}{4}(\colB,\GunY)
  ...
  \resizebox{0.9\textwidth}{!}{\includegraphics{static_figs/gun_poster.pdf}}\\
\end{textblock}
